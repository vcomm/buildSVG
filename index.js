...
SvgBuilder.prototype.animate = function animate(attrs, content) {
    this.addElement(new elements.Animate(attrs, content));
    return this;
};

SvgBuilder.prototype.polygon = function polygon(attrs, content) {
    this.addElement(new elements.Polygon(attrs, content));
    return this;
};
